...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('hs0_boatlocation', 'main'), true, true, true, function()
            ...
            RageUI.Button("Jetski", nil, {RightLabel = "~g~800$"},true, function(Hovered, Active, Selected)
            if (Selected) then   
            ...
            RageUI.Button("Bateau", nil, {RightLabel = "~g~1000$"},true, function(Hovered, Active, Selected)
            if (Selected) then   
